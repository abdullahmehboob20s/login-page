...
function StripesMobile() {
  return (
    <div className="fixed top-0 left-0 w-full h-full min-w-full -z-20 skew-y-[-12deg]">
      <div className="bg-light-blue h-[480px] -z-20 top-[-300px] absolute right-0 left-0"></div>
      ...
      <div className="fixed -top-100vh -bottom-100vh left-4 430px:left-[calc(50%-190px)] w-1px bg-light-blue-2 -z-20"></div>
      <div className="fixed -top-100vh -bottom-100vh right-4 430px:left-[calc(50%+190px)] w-1px bg-light-blue-2 -z-20"></div>
    </div>
  );
}
