...
function StripesDesktop() {
  return (
    <div className="fixed top-[-250px] left-0 right-0 bottom-0 h-full w-full skew-y-[-12deg] -z-50">
      <div className="h-[1698px] absolute top-[-1000px] -z-10 left-0 right-0 bg-light-blue"></div>
      ...
      {/* LINES */}
      <div className="fixed -top-100vh -bottom-100vh left-[calc(50%-540px)] w-1px bg-light-blue-2 -z-10"></div>
      <div className="fixed -top-100vh -bottom-100vh left-[calc(50%+540px)] w-1px bg-light-blue-2 -z-10"></div>
